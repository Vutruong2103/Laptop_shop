        ...
        <div className="bg-white shadow-sm mb-5">
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => navigate("/product")} className="bg-blue-600 text-white px-6 py-3 !rounded-button hover:bg-blue-700 transition-colors cursor-pointer whitespace-nowrap">
